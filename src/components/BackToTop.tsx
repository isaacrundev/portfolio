...
const BackToTop = () => {
  ...
  return (
    <button
      ...
      id="btn-back-to-top"
      onClick={handleClick}
      className="fixed inline-block p-1 uppercase transition duration-150 ease-in-out bg-white rounded-full shadow-md w-14 h-14 hover:bg-gray-300 hover:shadow-lg focus:bg-gray-200 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-300 active:shadow-lg bottom-5 right-5"
    >
